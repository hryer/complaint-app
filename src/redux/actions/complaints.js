...
import {
  ...
  REQUEST_EDIT_COMPLAINT, REQUEST_EDIT_COMPLAINT_SUCCESS, REQUEST_EDIT_COMPLAINT_FAILED, REQUEST_DETAIL_COMPLAINT_SUCCESS, REQUEST_DETAIL_COMPLAINT_FAILED,
  RESET_COMPLAINTS_REQUEST
} from './types';

export const resetComplaintsRequest = createAction(RESET_COMPLAINT_REQUEST);
